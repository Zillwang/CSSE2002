...
Openhttps://csse2002.uqcloud.net/assignment/2/in your web browser. Note that this
will only be the most recent version of the Javadoc.
Navigate to the relevant assignments folder underAssessmenton Blackboard and you will
...
Tasks
Implement the classes and methods described in the Javadoc as being requried for assignment
two.
Implement the indicated features of the user interface.
Write JUnit 4 tests for all the methods in the following classes:
...
IfF <5, thenR= 0 and code style will not be marked.
IfR > F, thenR=F.
...
if your tests take more than 20 seconds to run, or
if your tests consume more memory than is reasonable or are otherwise malicious,
